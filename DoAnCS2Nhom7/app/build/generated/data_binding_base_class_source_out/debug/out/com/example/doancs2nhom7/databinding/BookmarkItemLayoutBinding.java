...
public final class BookmarkItemLayoutBinding implements ViewBinding {
  ...
  private BookmarkItemLayoutBinding(@NonNull LinearLayout rootView, @NonNull View divider3,
  ...
  @NonNull
  public static BookmarkItemLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static BookmarkItemLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.bookmark_item_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static BookmarkItemLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new BookmarkItemLayoutBinding((LinearLayout) rootView, divider3, optionA, optionB,
