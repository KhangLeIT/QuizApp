...
public final class FragmentCategoryBinding implements ViewBinding {
  ...
  private FragmentCategoryBinding(@NonNull ConstraintLayout rootView, @NonNull GridView catGrid) {
  ...
  public static FragmentCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.cat_Grid;
      GridView catGrid = ViewBindings.findChildViewById(rootView, id);
      if (catGrid == null) {
        break missingId;
      }

      return new FragmentCategoryBinding((ConstraintLayout) rootView, catGrid);
    }
