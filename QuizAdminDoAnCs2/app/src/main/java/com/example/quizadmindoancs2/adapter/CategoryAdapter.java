...
//        });
                ...
                AlertDialog dialog = new AlertDialog.Builder(myView.getContext())
                        ...
                        .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int which) {
                                ...
                                deleteQuiz(i,myView.getContext());
                                Intent intent = new Intent(myView.getContext(), CategoryActivity.class);
                                myView.getContext().startActivity(intent);
                            }
                        })
    ...
    private void deleteQuiz(int i, Context context )
    {
        FirebaseFirestore g_firestore = FirebaseFirestore.getInstance();

        g_firestore.collection("QUIZ").document(DbQuery.g_catList.get(DbQuery.g_select_cat_index).getDocID()).delete();
    }
