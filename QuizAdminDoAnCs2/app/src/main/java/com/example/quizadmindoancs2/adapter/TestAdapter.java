...
public class TestAdapter extends RecyclerView.Adapter<TestAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            View customLayout = LayoutInflater.from(itemView.getContext()).inflate(R.layout.edit_test_dialog, null);
        ...
        private void setData(final int pos){
            ...
            itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    if(editTestFT == true){
                        ...
                        editTestFT = true;
                        editCatDialog.show();
                        editTimeTest.setText(String.valueOf(String.valueOf(DbQuery.g_testList.get(idTest).getTime())));
            ...
            ed_cancelB.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    itemView.getContext().startActivity(it);
                    ((Activity)itemView.getContext()).finish();
                    editCatDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                        @Override
                        public void onDismiss(DialogInterface dialogInterface) {
                            Toast.makeText(itemView.getContext(), "dddd", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            });
